 ...
 */
    __pyx_t_6 = __Pyx_PyIndex_AsSsize_t(__pyx_v_i); if (unlikely((__pyx_t_6 == (Py_ssize_t)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 73; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    ...
    (__pyx_v_zod[__pyx_t_7]) = (__pyx_v_out[__pyx_t_6]);
 ...
 */
  ...
  /* "/Users/jsw/python/natgrid/src/_natgrid.pyx":74
 *     for i from 0 <= i < buflenzo/8:
 *         zod[i] = out[i]
 *     if ier != 0:             # <<<<<<<<<<<<<<
 *        raise RuntimeError('error in natgridd - ier ='%ier)
 */
  __pyx_t_2 = (__pyx_v_ier != 0);
  if (__pyx_t_2) {

    /* "/Users/jsw/python/natgrid/src/_natgrid.pyx":75
 *         zod[i] = out[i]
 *     if ier != 0:
 *        raise RuntimeError('error in natgridd - ier ='%ier)             # <<<<<<<<<<<<<<
 */
    __pyx_t_3 = PyInt_FromLong(__pyx_v_ier); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_4 = PyNumber_Remainder(((PyObject *)__pyx_kp_s_4), __pyx_t_3); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    ...
    __pyx_t_4 = 0;
    __pyx_t_4 = PyObject_Call(__pyx_builtin_RuntimeError, __pyx_t_3, NULL); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 75; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_Raise(__pyx_t_4, 0, 0);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
...
static struct PyMethodDef __pyx_methods[] = {
  {__Pyx_NAMESTR("seti"), (PyCFunction)__pyx_pf_8_natgrid_seti, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("setr"), (PyCFunction)__pyx_pf_8_natgrid_setr, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {__Pyx_NAMESTR("natgridd"), (PyCFunction)__pyx_pf_8_natgrid_natgridd, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)},
  {0, 0, 0, 0}
};
...
#else
PyMODINIT_FUNC PyInit__natgrid(void); /*proto*/
PyMODINIT_FUNC PyInit__natgrid(void)
#endif
{
  ...
  __pyx_refnanny = __Pyx_RefNanny->SetupContext("PyMODINIT_FUNC PyInit__natgrid(void)", __LINE__, __FILE__);
  #endif
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("_natgrid"), __pyx_methods, __Pyx_DOCSTR(__pyx_k_5), 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main__natgrid) {
  ...
  /* "/Users/jsw/python/natgrid/src/_natgrid.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Pyrex wrapper for NCAR natgrid library for interpolation
 * of irregularly spaced data to a grid.
 */
  ...
  if (__pyx_m) {
    __Pyx_AddTraceback("init _natgrid");
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init _natgrid");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
